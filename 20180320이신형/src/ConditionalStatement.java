...
public class ConditionalStatement {
	...
	public static void main(String[] args) {
		...
		//성적이 60점 이상이면 "합격입니다.". 60점 미만이면 " 불합격입니다." 를 출력하도록 짜보기
		//if(조건식) {참일경우 수행 }else {거짓일경우 수행}  참일경우 거짓일경우 안에 문장이 여러개면 중괄호로 감싸주 ㄴ당.
		
		if(score >= 60) {
			System.out.println("합격입니다.");
			good++;
		} //복학문 compound Statement : 여러 문장을 증괄호{}로 묶어 하나의 문장으로 처리 
		else {
